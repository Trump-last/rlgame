...
def train_phase1():
    print("=" * 60)
    print("Phase 1: Learning basic landing (no centered penalty)")
    print("=" * 60)
...
def train_phase2():
    ...
    print("\n" + "=" * 60)
    print("Phase 2: Fine-tuning centered landing (penalty coeff=0.03)")
    print("=" * 60)
...
def main():
    ...
    if not train_phase1():
        print("\nTraining failed at phase 1.")
        return

    if not train_phase2():
        print("\nTraining failed at phase 2.")
        return

    print("\n" + "=" * 60)
    print("All phases complete!")
    print("Final model: models/ppo_lunarlander.zip")
    print("=" * 60)
